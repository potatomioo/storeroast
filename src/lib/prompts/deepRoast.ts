...
Return JSON exactly in this format. (THIS IS A PAID ROAST, BE INCREDIBLY FUNNY):
{
  "share_certificate": {
    ...
    "brand_color": "Extract the brand's primary color from their visual identity/screenshots. Convert that color into a VERY LIGHT pastel hex code suitable for a background behind dark text (e.g. Spotify -> pastel green #dcfce7, Netflix/YouTube -> pastel red #ffe4e6, Stripe -> pastel violet #ede9fe, Duolingo -> pastel lime #ecfccb). Do NOT default to blue unless the brand is genuinely blue. If unknown or neutral, return warm sticky-note yellow #fef08a.",
