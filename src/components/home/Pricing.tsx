...
export default function Pricing({ onBuy, isLoggedIn, onBack }: { onBuy?: () => Promise<void> | void, isLoggedIn?: boolean, onBack?: () => void }) {
  ...
  return (
    <section id="pricing" className="mt-20 mx-auto w-full max-w-5xl flex flex-col items-center px-4 relative">
      {onBack && (
        <button onClick={onBack} className="absolute -top-12 left-4 md:left-0 flex items-center gap-2 text-gray-500 hover:text-black font-medium transition-colors">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 w-full max-w-3xl mb-32">
        ...
        <div className="border border-gray-200 rounded-[2rem] p-8 flex flex-col bg-[#fcfcfc] flex-1 max-w-sm">
          <div className="text-[10px] font-bold tracking-widest uppercase bg-gray-200 px-3 py-1 rounded-md w-fit mb-6 text-gray-500">SURFACE LEVEL</div>
          <h3 className="text-3xl font-black text-gray-900 mb-2 tracking-tight font-handwriting">Free Roast</h3>
        ...
        <div className="border-4 border-black rounded-[2rem] p-8 flex flex-col bg-[var(--primary-yellow)] flex-1 max-w-sm shadow-2xl relative rotate-1 hover:rotate-0 transition-transform">
          ...
          <div className="text-[10px] font-bold tracking-widest uppercase bg-white text-black px-3 py-1 rounded-md w-fit mb-6 shadow-sm">VISUAL EVIDENCE</div>
          <h3 className="text-3xl font-black text-black mb-2 tracking-tight font-handwriting">Deep Burn</h3>
      ...
      <div className="w-full max-w-4xl flex flex-col items-center">
        <h2 className="text-4xl font-black tracking-tight mb-16 text-gray-900">What's Included</h2>
        ...
        <div className="w-full border-t-2 border-gray-900">
          ...
          <div className="grid grid-cols-3 py-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
            <div className="text-sm font-bold text-gray-900 col-span-1 flex items-center">Roast level</div>
            <div className="text-sm font-medium text-gray-500 text-center flex items-center justify-center">Basic</div>
            <div className="text-sm font-black text-gray-900 text-center flex items-center justify-center">Brutal as me</div>
          </div>

          <div className="grid grid-cols-3 py-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
            <div className="text-sm font-bold text-gray-900 col-span-1 flex items-center">VISUAL EVIDENCE</div>
          ...
          <div className="grid grid-cols-3 py-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
            <div className="text-sm font-bold text-gray-900 col-span-1 flex items-center">Explained Report</div>
            <div className="text-sm font-medium text-gray-500 text-center flex items-center justify-center">Basic</div>
            <div className="text-sm font-black text-gray-900 text-center flex items-center justify-center">Detailed Breakdown</div>
          </div>
